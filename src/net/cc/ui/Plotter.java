...
public class Plotter extends JFrame implements ChangeListener, ActionListener, KeyListener, MouseWheelListener {
	...
	private final JSlider apoapsis, perapsis, time;
	...
	public Plotter() {
	    ...
	    this.orbitChartPanel.setPreferredSize(new Dimension(500,300));
	    ...
	    this.anomalyChartPanel.setPreferredSize(new Dimension(500,300));
	...
	public void stateChanged(ChangeEvent e) {
		try {
			...
			Orbit orbit = new Orbit(new Mass(1.0,1.0),new Mass(1.0,1.0), perapsis, apoapsis, steps);
		    ...
		    this.orbitChartPanel.setChart(getOrbitChart(steps, orbit));
	...
	public JFreeChart getAnomalyChart(int steps, Orbit orbit) {
	    ...
	    JFreeChart chart = ChartFactory.createScatterPlot(chartTitle,
	            xAxisLabel, yAxisLabel, (XYDataset)dataset);
		...
		renderer.setSeriesShape(1, new Ellipse2D.Double(0,0,1,1));
		renderer.setSeriesPaint(1, Color.GREEN);
		renderer.setSeriesStroke(1, new BasicStroke(1.0f));
		renderer.setSeriesShape(2, new Ellipse2D.Double(0,0,1,1));
	...
	public JFreeChart getOrbitChart(int steps, Orbit orbit) {
        XYSeriesCollection dataset = new XYSeriesCollection();
		...
		renderer.setSeriesStroke(2, new BasicStroke(1.0f));
		renderer.setSeriesShape(2, new Ellipse2D.Double(-20,-20,20,20));
