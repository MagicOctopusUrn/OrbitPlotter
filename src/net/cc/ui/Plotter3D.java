...
public class Plotter3D extends JFrame implements ChangeListener, ActionListener, KeyListener, MouseWheelListener {
	/**
	 * 
	 */
	...
	public void stateChanged(ChangeEvent e) {
		try {
			...
			int steps = Integer.parseInt(this.steps.getText());
			Orbit2D orbit = new Orbit2D(new Mass(1.0, 1.0), new Mass(1.0, 1.0), perapsis, apoapsis, perapsisArgument, steps, true);
	...
	public JFreeChart getVelocityChart(int steps, Orbit2D orbit) {
	...
	public JFreeChart getAnomalyChart(int steps, Orbit2D orbit) {
		XYSeriesCollection dataset = new XYSeriesCollection();
	...
	public JFreeChart getOrbitChart(int steps, Orbit2D orbit, int t) {
		XYSeriesCollection dataset = new XYSeriesCollection();
